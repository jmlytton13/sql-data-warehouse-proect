...
BEGIN
	...
	BEGIN TRY
		...
		/*
		====================================================================================================
		INSERT into silver.crm_cust_info table
		====================================================================================================
		*/
		...
		*/
		...
		SELECT
			...
			CASE UPPER(TRIM(prd_line))
				...
				WHEN 'T' THEN 'Touring'
				ELSE 'n/a'
			END prd_line,    -- Map to more readbale
		...
		/*
		====================================================================================================
		INSERT into silver.crm_sales_details table
		====================================================================================================
		*/
		SET @start_time = GETDATE();
		...
		*/
		...
		PRINT '    - Total Load Duration: ' + CAST (DATEDIFF(second, @silver_start, @silver_end) AS NVARCHAR) + ' seconds';
		PRINT '=========================================================';
